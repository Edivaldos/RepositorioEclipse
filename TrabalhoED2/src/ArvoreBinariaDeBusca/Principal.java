...
public class Principal {
	public static void main(String args[]) {
		...
		System.out
				.println("--> O elemento  15 " + (noArvore.busca(15) ? "existe na árvore." : "não existe na árvore."));
		System.out
				.println("--> O elemento  19 " + (noArvore.busca(19) ? "existe na árvore." : "não existe na árvore."));
		System.out
				.println("--> O elemento  25 " + (noArvore.busca(25) ? "existe na árvore." : "não existe na árvore."));
		System.out.println("--> O elemento  7 " + (noArvore.busca(7) ? "existe na árvore." : "não existe na árvore."));
		System.out
				.println("--> O elemento  38 " + (noArvore.busca(38) ? "existe na árvore." : "não existe na árvore."));
		System.out
				.println("--> O elemento  10 " + (noArvore.busca(10) ? "existe na árvore." : "não existe na árvore."));
		System.out.println(
		...
		// 4º Caso (passando para o 2º) - Removendo um nó que tem filho à
		// esquerda e filho à direita:
		elem.setValor(10);
		noArvore = noArvore.remover(elem);

		// 4º Caso (passando para o 1º) - Removendo um nó que tem filho à
		// esquerda e filho à direita:
		elem.setValor(14);
		noArvore = noArvore.remover(elem);

		// Caso Excepcional - Removendo um nó que não existe na árvore, mas, se
		// existisse estaria à esquerda de seu antecessor.
		elem.setValor(16);
		noArvore = noArvore.remover(elem);

		// Caso Excepcional 2 - Removendo um nó que não existe na árvore, mas,
		// se existisse estaria à direita de seu antecessor.
		elem.setValor(29);
		noArvore = noArvore.remover(elem);
		...
		System.out
				.println("----------------------->> Teste de Busca na árvore após remoções <<-----------------------");
		System.out
				.println("--> O elemento 20" + (noArvore.busca(20) ? " existe na árvore." : " não existe na árvore."));
		System.out.println("--> O elemento 1" + (noArvore.busca(1) ? " existe na árvore." : " não existe na árvore."));
		System.out.println("--> O elemento 7" + (noArvore.busca(7) ? " existe na árvore." : " não existe na árvore."));
		System.out
				.println("--> O elemento 12" + (noArvore.busca(12) ? " existe na árvore." : " não existe na árvore."));
		System.out
				.println("--> O elemento 10" + (noArvore.busca(10) ? " existe na árvore." : " não existe na árvore."));
		System.out
				.println("--> O elemento 14" + (noArvore.busca(14) ? " existe na árvore." : " não existe na árvore."));
		System.out
				.println("--> O elemento 28" + (noArvore.busca(28) ? " existe na árvore." : " não existe na árvore."));
		System.out
				.println("--> O elemento 29" + (noArvore.busca(29) ? " existe na árvore." : " não existe na árvore."));
		System.out.println("\n-------------------------->> Fim do Programa! <<--------------------------");
	}
}
